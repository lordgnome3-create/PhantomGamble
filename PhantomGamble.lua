...
local function CreateStatsWindow()
	...
	-- Resize grip with visible placeholder
...
local function CreateDebtsWindow()
	...
	f:SetWidth(300)
	f:SetHeight(300)
	-- FIX: Changed offset from 300 to 10 so it appears next to main frame (was off-screen)
	f:SetPoint("LEFT", PhantomGamble_Frame, "RIGHT", 10, 0)
	f:SetMovable(true)
	f:SetResizable(true)
	f:EnableMouse(true)
...
local function CreateMainFrame()
	...
	-- Warning button (replaces the old disclaimer text)
	-- Uses a clickable button frame so both hover and click work
	local warningBtn = CreateFrame("Button", "PhantomGamble_WarningButton", f)
	warningBtn:SetWidth(60)
	warningBtn:SetHeight(16)
	warningBtn:SetPoint("LEFT", title, "RIGHT", 8, 0)
	
	local warningText = warningBtn:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
	warningText:SetPoint("LEFT", warningBtn, "LEFT", 0, 0)
	warningText:SetText("|cffff0000[Warning]|r")
	warningBtn:SetWidth(warningText:GetStringWidth() + 4)
	
	warningBtn:SetHighlightTexture("Interface\\Buttons\\UI-Panel-Button-Highlight")
	warningBtn:SetScript("OnEnter", function()
		GameTooltip:SetOwner(this, "ANCHOR_BOTTOM")
		GameTooltip:SetText("|cffff0000Gambling Restriction|r")
		GameTooltip:AddLine("This addon should only be used in", 1, 1, 1)
		GameTooltip:AddLine("Bilgewater Cartel cities:", 1, 0.82, 0)
		GameTooltip:AddLine(" ")
		GameTooltip:AddLine("  - Ratchet", 0.5, 1, 0.5)
		GameTooltip:AddLine("  - Booty Bay", 0.5, 1, 0.5)
		GameTooltip:AddLine("  - Everlook", 0.5, 1, 0.5)
		GameTooltip:AddLine("  - Gadgetzan", 0.5, 1, 0.5)
		GameTooltip:Show()
	end)
	warningBtn:SetScript("OnLeave", function() GameTooltip:Hide() end)
	warningBtn:SetScript("OnClick", function()
		-- Toggle a chat message with the info on click as well
		DEFAULT_CHAT_FRAME:AddMessage("|cffff0000[PhantomGamble Warning]|r Gambling is only permitted in Bilgewater Cartel cities: |cff00ff00Ratchet|r, |cff00ff00Booty Bay|r, |cff00ff00Everlook|r, |cff00ff00Gadgetzan|r")
	end)
	...
	-- Resize grip with visible placeholder label
